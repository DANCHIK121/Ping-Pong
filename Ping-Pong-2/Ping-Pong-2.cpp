...
void main()
{
    ...
    WorkWithAudio::Audio ballBouncedAudio;
    WorkWithAudio::Audio ballBouncedOffAudio;
    ...
    ballBouncedAudio.SetVolume(volume);
    ballBouncedOffAudio.SetVolume(volume);
